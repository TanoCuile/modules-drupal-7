...
/** @package miiCard.Consumers */
    use miiCard\Consumers\Model\MiiApiCallStatus;
    use miiCard\Consumers\Model\MiiApiResponse;
    use miiCard\Consumers\OAuth\OAuthConsumer;
    use miiCard\Consumers\OAuth\OAuthRequest;
    use miiCard\Consumers\OAuth\OAuthSignatureMethod_HMAC_SHA1;
    use miiCard\Consumers\OAuth\OAuthToken;
    ...
    class MiiCardOAuthClaimsService extends MiiCardOAuthServiceBase
    {
        ...
        public function getIdentitySnapshotDetails($snapshotId)
        {
            ...
            return $this->makeRequest('GetIdentitySnapshotDetails', json_encode($requestArray), 'miiCard\Consumers\Model\IdentitySnapshotDetails::FromHash', true, true);
        }
        ...
        public function getIdentitySnapshot($snapshotId)
        {
            ...
            return $this->makeRequest('GetIdentitySnapshot', json_encode($requestArray), 'miiCard\Consumers\Model\IdentitySnapshot::FromHash', true);
        }
