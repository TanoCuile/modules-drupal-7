...
<div class="miicard-profile">
  ...
  <?php if ($miicard->getIdentityAssured()): ?>
    <p class="assured"><?php print t("This user has verified their identity by attaching a miiCard to their account. ") . l(t("What is miiCard?"), miicard_url("http://www.miicard.com/how-it-works"), array('attributes' => array('target' => '_blank'))); ?></p>
  <?php else: ?>
